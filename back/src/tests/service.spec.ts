...
describe("Testing toSortedByPoints function", async () => {
  it("Should sort in ascending order news by points.", async (t) => {
...
describe("Testing toSortedByNumberOfComments function", async () => {
  it("Should sort in ascending order news by number of comments.", async (t) => {
    const expectedOutput: News[] = [
      { number: 3, title: "Third News", points: 120, numberOfComments: 60 },
      { number: 1, title: "First News", points: 100, numberOfComments: 50 },
      { number: 4, title: "Fourth News", points: 80, numberOfComments: 30 },
...
describe("Testing filterByWords function", async () => {
  it("Should filter news with title greather than 5", async (t) => {
  ...
  it("Should filter news with title lower or equal than 5", async (t) => {
  ...
  it("Should filter news with title lower or equal than 6", async (t) => {
  ...
  it("Should filter news with title greather than 2", async (t) => {
...
describe("Testing getNumberOfWords function", async () => {
  it("Should return number of words without symbols and not counting empty spaces", async (t) => {
...
describe("Testing sortAndFilterNews function", async () => {
  it("Should filter news with title with more than 5 words and then sort by number of comments", async (t) => {
    const expectedOutput: News[] = [
      {
        number: 5,
        title: "Fifth News news news news news news news news",
  ...
  it("Should filter news with title with less or equal than 5 words and then sort by points", async (t) => {
    const expectedOutput: News[] = [
      { number: 2, title: "Second News", points: 150, numberOfComments: 20 },
      { number: 3, title: "Third News", points: 120, numberOfComments: 60 },
      {
  ...
  it("Should return all news", async (t) => {
...
describe("Testing parseTitleRow function", async () => {
  it("Should return partial news with title and number.", async (t) => {
    const dom = new JSDOM(`
     <div class="item">
